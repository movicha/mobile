package com.clouidio.treexmlparser;
...
public class XMLNode {
    ...
    public List<XMLNode> queryNodes(String query) {
		...
		XMLNode node = queryNode(queryTokens, 0, queryTokens.length - 2);
     ...
     */
    protected XMLNode queryNode(String[] queryTokens, int firstIndex,
            int lastIndex) {
